...
const NavButton = ({ title, customFunc, icon, color, dotColor }) => (
  <TooltipComponent content={title} position="BottomCenter">
    <button type='button' onClick={customFunc} style={{ color }} className="relative text-xl rounded-full p-3 hover:btn-light-gray">
...
const NavBar = () => {
  const { isCliked, setIsCliked, activeMenu, setActiveMenu, handleClick, screenSize, setScreenSize, currentColor } = useStateContext();
